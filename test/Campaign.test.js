...
describe('Campaigns', () => {
    ...
    it('allows people to ontribute money and marks them as approvers', async () => {
    ...
    it('allows a manager to make a payment request', async () => {
        await campaign.methods.createRequest('buy battaries', '100', accounts[1]).send({
            from: accounts[0],
            gas: '1000000'
        });
    ...
    it('processes request', async () => {
        ...
        await campaign.methods.createRequest('Buy battaries', web3.utils.toWei('5', 'ether'), accounts[1]).send({
            from: accounts[0],
            gas: '1000000'
        });
        ...
        assert(balance > 104.95);
        assert(balance < 105.01);
    });
});